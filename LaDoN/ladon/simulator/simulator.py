...
import ladon.helpers.helpers as helpers
...
my_network2 = make_network_by_seed(dictionary=dictionary, run=1, run_simulation=False)
my_network2.run_simulation()

helpers.calculate_jsd_from_path_distributions(my_network.graph, my_network2.graph)
...
plot_graph(my_network2, plot_type="agent_type")
